...
To read multiple lines of input in Java, you can use the `Scanner` class. Here's an example of how you can modify your code to read multiple lines of input:
