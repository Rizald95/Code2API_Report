...
public class Main {
    ...
    public static Date getDateFiveSecondsFromNow() {
        Calendar calendar = Calendar.getInstance(); // gets a calendar using the default time zone and locale.
        calendar.add(Calendar.SECOND, 5);
    ...
    public static void main(String args[]) {
        System.out.println(getDateFiveSecondsFromNow());
    }
}

    
This method returns a Date object representing the current date and time plus 5 seconds. The main method demonstrates how to use the method