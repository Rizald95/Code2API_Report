...
* We create a 2D array arr of size n x n.
* We initialize a variable inc to 1.
* We iterate over the rows and columns of the array, and for each cell, we set its value to the current value of inc, and then increment inc by 1.
* This will fill the array with the numbers from 1 to n^2, in a row-major order.
* Finally, we can print the array as