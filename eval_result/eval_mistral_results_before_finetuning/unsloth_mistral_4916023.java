...
public class Foo2 {
    public static void main(String[] args) {
        String line = "DBREF 1A1F A  102   190  UNP    P08046   EGR1_MOUSE     308    396";
        Pattern pattern = Pattern.compile("\\s+([a-zA-Z])\\s+\\d+\\s+\\d+");
        Matcher matcher = pattern.matcher(line);
        while (matcher.find()) {
            System.out.println("Pattern exists: " + matcher.group());
        }
    }
}

This code will find the pattern "A 102 190" in the line "DBREF 