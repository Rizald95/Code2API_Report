...
public class Test {
    public static void main(String[] args) throws Exception {
        ...
        String[] cmd = { "C:\\Program Files\\E.M. TVCC\\TVCC.exe", "-f C:\\Program Files\\E.M. TVCC\\TestVideo\\01.avi", "-o C:\\Program Files\\E.M. TVCC\\OutputFiles\\target.3gp" };
        Runtime.getRuntime().exec(cmd);
    }
}
...
Exception in thread "main" java.io.IOException: Cannot run program "C:\Program Files\E.M. TVCC\TVCC.exe": CreateProcess error=2, The system cannot find the file specified

I have checked the path and the file is present there.

Answer:

The error you are getting is because the path to the executable file is incorrect.