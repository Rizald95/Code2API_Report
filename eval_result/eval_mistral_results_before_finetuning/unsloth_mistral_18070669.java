...
public class Runcommand3
{
 ...
 class ButtonHandler implements ActionListener{
                ...
                try{
                Process p = Runtime.getRuntime().exec("cmd /c echo " + value + " > C:\\Users\\user\\Desktop\\test.txt");
                }catch(IOException e){
                e.printStackTrace();
                }
                try{
                Process p = Runtime.getRuntime().exec("cmd /c C:\\Users\\user\\Desktop\\test.bat");
                }catch(IOException e){
                e.printStackTrace();
                }
                }
...
Answer: To create a standalone Java application that takes user input, writes it to a