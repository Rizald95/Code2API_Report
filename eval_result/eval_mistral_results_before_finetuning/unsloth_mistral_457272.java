...
If you use the -XX:+HeapDumpOnOutOfMemoryError option to the JVM, and then use a tool like VisualVM to examine the heap dump, you should be able to see exactly what objects are being held onto at the time of the OOME.  This should help you track down the source of the leak.