...
Note that this regex will not work if the names or values contain special characters like spaces, commas, semicolons, etc. If that's the case, you'll need to escape