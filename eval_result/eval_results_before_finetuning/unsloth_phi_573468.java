...
1. First, you need to import your certificate into a keystore using the keytool command. Here's how you can do it:

```bash
keytool -importcert -file C:/Cacert.der -alias myCert -keystore mytruststore -storepass changeit
```

Replace `myCert` with a name for your certificate and `changeit` with your keystore password.

2. Next, you need to set the system properties to use your truststore. Here's how you can do it:
