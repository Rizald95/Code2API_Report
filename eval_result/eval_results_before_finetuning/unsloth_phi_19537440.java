...
In the above code, replace "ENTRY_FROM_TNSNAMES" with the actual entry from your tnsnames.ora file. For example, if your tnsnames.ora file contains the following entry:
