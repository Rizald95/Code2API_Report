...
public class ProcessInfo {
    ...
    public static void main(String[] args) {
        System.out.println(isProcessRunning("java"));
    }
}

A: You can use the ProcessBuilder class to run the tasklist command.
Here is a sample code:
public static boolean isProcessRunning(String processName) {
    try {
        ProcessBuilder pb = new ProcessBuilder("cmd", "/c", "tasklist /FI \"IMAGENAME eq java\"");
