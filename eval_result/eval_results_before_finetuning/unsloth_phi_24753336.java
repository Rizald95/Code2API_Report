...
Here's a complete Java method that splits a double number into its integer and decimal parts:
...
public class DoubleSplitter {
    ...
    public static void main(String[] args) {
        double val = 1.9;
        int[] result = splitDouble(val);
        System.out.println("Integer part: " + result[0]);
        System.out.println("Decimal part: " + result[1]);
    }

    public static int[] splitDouble(double val) {
