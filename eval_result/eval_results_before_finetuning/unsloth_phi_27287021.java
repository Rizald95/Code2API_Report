...
mySet1.removeAll(mySet2); // remove all elements of mySet2 from mySet1
String[] result = mySet1.toArray(new String[0]); // convert back to array

A:

You can use the retainAll method of the ArrayList class.
