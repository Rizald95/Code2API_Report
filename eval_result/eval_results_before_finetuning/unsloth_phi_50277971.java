...
The DateTimeFormatterBuilder.getLocalizedDateTimePattern method returns a pattern string that is suitable for formatting a date-time object according to the specified format style and locale. For example, if we want to format a date-time object as "Thursday, May 10, 2018" in the US locale, we can use the FormatStyle.FULL style, which includes the day of week, month, day, and year. The method will return a pattern like "EE