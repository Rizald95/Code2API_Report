...
public class CallerIdentifier {
    ...
    public static void operation() {
        ...
        // Check if the second element (excluding the current method) is "performancetest"
        StackTraceElement callerElement = stackTrace[2]; // Index 2 corresponds to the caller method
        if ("performancetest".equals(callerElement.getMethodName())) {
