...
public static void main(String[] args) throws IOException {
    ...
    g.drawImage(img, 0, 0, null);
    if (g != null) g.dispose();
    BufferedImage img_transparent = new BufferedImage(125, 125, BufferedImage.TYPE_INT_ARGB);
    Graphics2D g_transparent = img_transparent.createGraphics();
    g_transparent.drawImage(img_logo, 0, 0, null);
    g_transparent.dispose();
    ImageIO.write(img_transparent, "png", uploadedFile);
}

A: You can use BufferedImage.