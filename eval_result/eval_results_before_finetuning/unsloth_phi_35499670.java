...
A: Your first attempt is almost correct. The problem is that you are not using the compareTo method in your main method.
Here is a corrected version of your first attempt:
public class Name implements Comparable<Name> {
    ...
    public int compareTo(Name other) {
        ...
        if (getName().compareTo(other.getName