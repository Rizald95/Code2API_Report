...
I would like to know how can I connect to my local machine's database? What should I put in the String parameter of DriverManager.getConnection()?

Upadte: 
I tried with localhost and it works.

String dbURL = "jdbc:mysql://localhost:3306/chandb";


    
Answer: 
You can try with localhost as host name.

String dbURL = "jdbc:mysql://localhost:3306/chandb";

    
Code String dbURL = "jdbc:mysql://localhost:3306/chandb";
