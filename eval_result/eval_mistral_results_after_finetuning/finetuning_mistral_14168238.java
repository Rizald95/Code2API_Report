...
How to create and show common dialog (Error, Warning, Confirmation) in JavaFX 2?

How to create a JavaFX modal dialog?

How to create a JavaFX dialog with a custom title bar?

How to create a JavaFX dialog with a custom title bar and a custom close button?

How to create a JavaFX dialog with a custom title bar and a custom close button and a custom OK button?
