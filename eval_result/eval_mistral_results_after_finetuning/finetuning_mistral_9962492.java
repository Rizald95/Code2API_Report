...
You can use logarithms.
    ...
    {
        double tenthPower = Math.pow(10, 3);
        System.out.println("The number of thousands in " + values[i] + " is " + ((int)(values[i]/tenthPower)) );
        tenthPower /= 10;
        System.out.println("The number of hundreds in " + values[i] + " is " + ((int)(values[i]/tenthPower)) % 10 * 10);
        System.out.println("The number of tens in " + values[i] + " is " + ((int)(values[i]/tenthPower)) % 10 * 100);
        System.