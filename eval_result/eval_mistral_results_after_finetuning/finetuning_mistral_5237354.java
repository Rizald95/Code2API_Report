...
14:24:10,058 INFO  [STDOUT] IS NULL
14:24:10,058 INFO  [STDOUT] HAS NOTHING IN IT
14:24:10,058 INFO  [STDOUT] NOT NULL
14:24:10,058 INFO  [STDOUT] restrictList [lower(logs.clazz) like lower(concat(logs.clazz, '%')), lower(logs.rule) like lower(concat(logs.rule, '%')), lower(logs.priority) in (p1, p2, p3)]
