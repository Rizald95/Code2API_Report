...
Upadte the code as a full Java method.

# Answer

You are on the right track.

You can try running your command as an array of strings as follows:

String[] cmd = { "TVCC", "-f", "E:\\TestVideo\\01.avi", "-o", "E:\\OutputFiles\\target.3gp" };
Runtime.getRuntime().exec(cmd);
