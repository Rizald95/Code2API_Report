...
Edit1: I'm on Windows

Edit2: I tried with Scanner, it works in eclipse but when I run it as a java application it accepts only one number

Edit3: I tried with BufferedReader, it works in eclipse but when I run it as a java application it accepts only one number

Edit4: I tried with Scanner and new Scanner(System.in).nextLine(); It works in eclipse but when I run it as a java application it accepts only one number on a single line

Edit5: I tried with Scanner and new Scanner(System.in).nextLine