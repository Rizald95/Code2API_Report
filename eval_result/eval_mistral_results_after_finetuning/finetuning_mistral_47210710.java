...
I have also added a space after the question mark and colon (?:) operator which is a short form of if-else statement.
...
if (in.hasNextInt()) {
    z = in.nextInt();
    System.out.println(z + " is " + (z > 0 ? "positive." : (z < 0 ? "negative." : "equal to 0.")));
} else if (in.hasNextDouble()) {
