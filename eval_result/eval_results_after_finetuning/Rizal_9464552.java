...
You can use the `Matcher` `lookingAt()` method which checks if the entire string that you pass to it matches the regular expression or not. If it matches, it returns true, else it returns false.
