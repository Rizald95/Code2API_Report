...
You can use the `String#indexOf` method in a loop as follows:
...
Code:
    ...
    public static int countOccurrences(String input, String toFind) {
        ...
        while (index != -1) {
            count++;
            input = input.substring(index + toFind.length());
            index = input.indexOf(toFind);
        }
        return count;
    }

You can test the method as follows:
