...
Edit:
If you want to check if a process is running as a Java application, you can use the ProcessBuilder as I did in my example:
ProcessBuilder pb = new ProcessBuilder("ps", "-o", "comm", "java");
Process ps = pb.start();
