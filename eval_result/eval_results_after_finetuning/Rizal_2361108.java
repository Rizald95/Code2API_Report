...
This command will start a Java Virtual Machine and attempt to run the main method of the HelloWorld class. You should see the following text appear in the Terminal:
...
Answer: 
You can use the terminal on your Mac.

Answer: 
You can use the terminal on your Mac.

Answer: 
You can use the terminal on your Mac. Press Enter after each statement.
